            ...
            <div className={`search-popup ${isPopup ? "active" : ""}`}>
                ...
                <div className="search-popup__content">
                    <form action="#">
                        ...
                        <input type="text" id="search" placeholder="Search Here..." suppressHydrationWarning={true} />
                        <button type="submit" aria-label="search submit" className="thm-btn" suppressHydrationWarning={true}>
